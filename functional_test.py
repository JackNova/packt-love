...
class ScrapeTestCase(unittest.TestCase):
    ...
    def setUp(self):
        with open('fixtures/raw_html.html', 'r') as file:
            self.raw_html = file.read()

        with open('fixtures/my_ebooks_page.html', 'r') as file:
            self.my_ebooks_page = file.read()

    def test_scrape(self):
        get_book_url, book_title, new_form_id, image_url, book_description = scrape(self.raw_html,
